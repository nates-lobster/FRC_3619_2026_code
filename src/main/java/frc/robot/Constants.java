...
public final class Constants {
  ...
  public static final class FuelConstants {
    ...
    public static final double INDEXER_INTAKING_PERCENT = -1.0; 
    ...
    public static final double INDEXER_JAM_RPM_THRESHOLD = 50.0;
    public static final double INDEXER_JAM_SECONDS = 0.2;
